    ...
    return (
        <>
            ...
            <nav className="fixed xs:hidden m-1 mt-0 w-full z-10 top-0 px-10">
                ...
                <div className="nav  hidden nav-left p-3  md:flex">
                    <a href="">
                        Home
                    </a>
                    <a href="">
            ...
            <div className="main-grid-container w-full flex justify-center">
                <div className="newin-section grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4  w-11/12">
                    <div className="box col-span-4 mt-5 ">
