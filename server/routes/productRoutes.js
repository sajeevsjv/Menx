...
router.patch("/updatecart",setaccessControl("2,3"),productController.updateCart);
...
router.get("/sellerproducts/:id",setaccessControl("1,3"),productController.sellerProducts);
...
router.put("/blockproduct/:id",setaccessControl("1"),productController.toggleBlockProduct);
router.get("/newproducts/:id",productController.getNewInProducts);
router.put("/updateproduct/:id",setaccessControl("1,3"),productController.updateProduct);
router.get("/myearnings/:id",setaccessControl("1,3"),productController.myEarnings);
